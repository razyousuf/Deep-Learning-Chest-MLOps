...
class ConfigurationManager:
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        """
        Constructs the configuration for the evaluation stage.
        Returns:
            EvaluationConfig: A data class containing all configuration values
            needed by the Evaluation component.
        """
        # Package values into a structured EvaluationConfig object
        eval_config = EvaluationConfig(
            path_of_model="artifacts/training/model.h5",
            training_data="artifacts/data_ingestion/Chest-CT-Scan-data",
            mlflow_uri="https://dagshub.com/razyousufi350/Deep-Learning-Chest-MLOps.mlflow",
